...
class BookJDBCDaoImplIntegrationTest {
    ...
    @Order(2)
    void getById() {
        bookRepository.findAll().forEach(elemento -> {
            System.out.println("elemento.getId() = " + elemento.getId());
            System.out.println("elemento.getTitle() = " + elemento.getTitle());
            System.out.println("elemento.getAuthor().getId() = " + elemento.getAuthor().getId());
        });
